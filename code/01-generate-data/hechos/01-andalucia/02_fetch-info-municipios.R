...
OUTPUT_FILE <- "data-raw/hechos/01-andalucia/resumen_municipios.csv"
...
source("code/01-generate-data/hechos/01-andalucia/functions.R", encoding = "UTF-8")
...
get_resumen <- function(clave_eleccion , clave_provincia, clave_municipio) {

  endpoint <- "resumen/municipio"
