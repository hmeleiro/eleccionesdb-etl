...
OUTPUT_DIR <- "data-processed/hechos/00c-europeas/"

# --- Dimensiones ---
fechas <-
    read_csv("tablas-finales/dimensiones/elecciones", show_col_types = FALSE) %>%
    filter(tipo_eleccion == "E", year >= 1987) %>%
...
codigos_ccaa <- readRDS("data-raw/hechos/00c-europeas/codigos_ccaa.rds") %>% select(-ccaa)
...
INPUT_DIR <- "data-raw/hechos/00c-europeas/"
...
# ==========================================================================
# FALLBACK: elecciones sin datos de mesas
# ==========================================================================
...
validate_info(info, label = "00c-europeas/info")
validate_votos(votos, label = "00c-europeas/votos")
validate_info_votos_consistency(info, votos, label = "00c-europeas")
validate_votos_partido_match(votos, label = "00c-europeas/votos")
