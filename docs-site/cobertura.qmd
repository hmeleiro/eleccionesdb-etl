...
has_data <- file.exists(elecciones_path)
```
...
if (!has_data) {
  cat("::: {.callout-warning}\n")
  cat("Los datos de cobertura no están disponibles. Ejecuta el pipeline ETL para generarlos.\n")
  cat(":::\n")
} else {
